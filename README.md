...
In addition as a secondary goal we will attempt to eliminate the need for a 8284 and 8288 and replace these functions with CPLD technology.
So the main goal of this project is greatly reducing the XT computer in a smaller number of ICs and total PCB area.
Also we want to reduce the PCB complexity as a result of the above.
